                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                            ...
                            <form method="post" action="">
                                <!--<img src="<?php echo $this->config->item('base_url').'/uploads/WhatsApp.jpeg' ?>" height="120px" style="border-radius:50%; margin-left:35%;box-shadow:0px 2px 25px 10px #fff;" >-->
        ...
        <ul class="dropdown-menu">
            ...
            <li class="active">
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                    <img src="<?php echo base_url($this->config->item("new_theme")."/assets/img/sidebar-1.jpg"); ?>" data-src="<?php echo base_url($this->config->item("new_theme")."/assets/img/login.jpeg"); ?>" alt="" />
                </a>
            </li>
            <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                    <img src="<?php echo base_url($this->config->item("new_theme")."/assets/img/sidebar-2.jpg"); ?>" data-src="<?php echo base_url($this->config->item("new_theme")."/assets/img/lock.jpeg"); ?>" alt="" />
                </a>
            </li>
            <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                    <img src="<?php echo base_url($this->config->item("new_theme")."/assets/img/sidebar-3.jpg"); ?>" data-src="<?php echo base_url($this->config->item("new_theme")."/assets/img/header-doc.jpeg"); ?>" alt="" />
                </a>
            </li>
            <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                    <img src="<?php echo base_url($this->config->item("new_theme")."/assets/img/sidebar-4.jpg"); ?>" data-src="<?php echo base_url($this->config->item("new_theme")."/assets/img/bg-pricing.jpeg"); ?>" alt="" />
                </a>
            </li>
