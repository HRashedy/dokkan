                               ...
                               ?>
                                <div class="form-group">
                                    <div class="row">
                                       ...
                                       <div class="col-md-6">
                                        <label for="emp_fullname"><?php echo $this->lang->line("Employee Name");?></label>
                                        <input type="text" class="form-control" id="user_fullname" value="<?php echo $user->user_name; ?>" name="emp_fullname" placeholder="Employee Name" />
                                    </div>


                              <div class="col-md-6">
                                        <label for="mobile_no"><?php echo $this->lang->line("Mobile No");?></label>
                         <input type="text" class="form-control" value="<?php echo $user->user_phone; ?>"
                                        id="mobile" name="mobile" placeholder="Mobile No" />
                                    </div>

                                    <div class="col-md-6">
                                        <label for="user_email"> <?php echo $this->lang->line("User Email");?></label>
                                        <input type="email" class="form-control" id="user_email" value="<?php echo $user->user_email; ?>"  name="user_email" placeholder="user@gmail.com" />
                                    </div>

                                    <div class="col-md-6">
                                        <label for="user_password"><?php echo $this->lang->line("Login ID");?></label>
                                        <input type="text" class="form-control" id="user_password"  value="<?php echo $user->user_password; ?>"  name="user_password" placeholder="password" />
                                    </div>
                                   <!-- <div class="col-md-6">
